...
//                 value.map((item) =>
//                     item.id === id
//                         ? { ...item, filePath: response.filePath, fileName: file.name }
//                         : item
//                 )
//             );
//         } else {
...
//                     <tr className="bg-gray-100 text-slate-600 text-left">
//                         <td className="p-2 font-thin text-sm">Step</td>
//                         <th className="p-2 font-thin text-sm px-5">Description</th>
//                         <th className="p-2 font-thin text-sm px-5 w-1/4">Attachment</th>
//                         <th className="p-2 font-thin text-sm text-center">Remove</th>
//                     </tr>
//                 </thead>
//                 <tbody>
//                     {(value || []).map((att, index) => (
...
//                                 <Button
//                                     variant="outline"
//                                     className={`border-0 ${value.length === 1 ? "opacity-35" : ""}`}
//                                     onClick={() => handleRemoveAttachment(att.id)}
