...
//                         <span className="text-xs text-blue-800 font-semibold p-2 rounded-lg bg-blue-50">
//                             Pending
//                         </span>
//                     </div>
//                 </div>
...
//                         <div className="col-span-6 text-gray-500">Change Request Type:</div>
...
//                     </div>
//                     <div className="grid grid-cols-12 gap-4">
//                         <div className="col-span-6 text-gray-500">Start Date & Time:</div>
//                         <span className="col-span-6 font-medium">
//                             12:30 am, 19/10/24
//                         </span>
//                     </div>
//                     <div className="grid grid-cols-12 gap-4">
//                         <div className="col-span-6 text-gray-500">End Date & Time:</div>
//                         <span className="col-span-6 font-medium">
//                             12:30 am, 19/10/24
//                         </span>
//                     </div>
//                     <div className="grid grid-cols-12 gap-4">
//                         <div className="col-span-6 text-gray-500">Created By:</div>
//                         <span className="col-span-6 font-medium">
//                             Yuvraj Thakur
//                         </span>
//                     </div>
//                 </div>
//             </Card>
//             {/* Tabs (for the first pass, or can be made per-pass if needed) */}
//             <DefaultTab tabs={tabList} activeTab={activeTab} setActiveTab={setActiveTab} />
//             {/* Tab Content */}
//             <div className="mt-5 ">
//                 {activeTab === 'Details' && (
//                     selectedInwardType === 'clientdelivery' ? (
//                         // <ClientPassDetails />
//                         <ChangeRequiestDetails />
//                     ) : selectedInwardType === 'sifydelivery' ? (
//                         // <SifyPassDetails />
//                         <ChangeRequiestDetails />
//                     ) : selectedInwardType === 'vendordelivery' ? (
//                         // <VendorPassDetails />
//                         <ChangeRequiestDetails />
//                     ) : (
//                         // <ClientPassDetails />
...
//                     <Logs />
//                 )}
//                 {/* You can add more tab content rendering here for 'Attachments' if needed */}
//             </div>
//         </div>
//     );
// }
        ...
        <div className="p-6 min-h-screen overflow-auto h-screen pb-20">
            <Card className='mb-5 pt-0'>
                ...
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        <div className="font-bold text-xl">{currentPass.requestType}</div>
                        <div className="text-gray-500">{currentPass.requestId}</div>
                    </div>
                ...
                <div className="grid grid-cols-3 gap-7 mb-4 text-md">
                    <div className="grid grid-cols-12 gap-4">
                        <div className="col-span-6 text-gray-500">Change Request Type:</div>
                        <span className="col-span-6 font-medium">{currentPass.requestType}</span>
                    </div>
                    <div className="grid grid-cols-12 gap-4">
                        <div className="col-span-6 text-gray-500">Region:</div>
                        <span className="col-span-6 font-medium">{currentPass.region}</span>
                    </div>
                    <div className="grid grid-cols-12 gap-4">
                        <div className="col-span-6 text-gray-500">Site:</div>
                        <span className="col-span-6 font-medium">{currentPass.site}</span>
                    </div>
                    <div className="grid grid-cols-12 gap-4">
                        <div className="col-span-6 text-gray-500">Start Date & Time:</div>
                        <span className="col-span-6 font-medium">{currentPass.startDate}</span>
                    </div>
                    <div className="grid grid-cols-12 gap-4">
                        <div className="col-span-6 text-gray-500">End Date & Time:</div>
                        <span className="col-span-6 font-medium">{currentPass.endDate}</span>
                    </div>
                    <div className="grid grid-cols-12 gap-4">
                        <div className="col-span-6 text-gray-500">Created By:</div>
                        <span className="col-span-6 font-medium">{currentPass.createdBy}</span>
                    </div>
                </div>
            </Card>
