                    ...
                    <Card className='mb-5 pt-0'>
                        ...
                        <div className="mb-4 flex flex-col gap-2">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex items-center gap-4 w-full border-2 border-dashed border-gray-200 p-2 rounded-lg cursor-pointer" onClick={() => setShowPreApprovedEmailPopup(true)}>
                                    {/* <Image
                                        src={AttachmentGif}
                                        alt="Image 1"
                                        width={240}
                                ...
                                {showPreApprovedEmailPopup && (
                                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={() => setShowPreApprovedEmailPopup(false)}>
                        ...
                        <div className="mb-4 flex flex-col gap-2">
                            ...
                            <div className="flex items-center gap-4">
                                <div className="flex items-center gap-4 w-full border-2 border-dashed border-gray-200 p-2 rounded-lg cursor-pointer" onClick={() => setShowDCChallanPopup(true)}>
                                    {/* <Image
                                        src={AttachmentGif}
                                        alt="Image 1"
                                        width={240}
                                ...
                                {showDCChallanPopup && (
                                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={() => setShowDCChallanPopup(false)}>
