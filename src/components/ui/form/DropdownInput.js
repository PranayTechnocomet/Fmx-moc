...
const DropdownInput = ({
    ...
    return (
        <div
            ...
            ${inputContainerStyle} flex mb-6`}
        >
            {/* Label is removed — label will come from formbuilder */}

            <div className="relative flex items-center border rounded-md bg-white flex-col w-full">
                <input
                    id={id}
                    type={type}
                    value={value}
